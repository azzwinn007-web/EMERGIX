...
def _hash_password(password: str) -> str:
    ...
    For this project this provides a simple migration path
    from the existing demo plaintext passwords.
    """
...
def _is_hashed_password(password: str) -> bool:
    """
    Detect whether a stored password is already a
...
def authenticate(username, password):
    ...
    # Never send the stored password back to the frontend.
